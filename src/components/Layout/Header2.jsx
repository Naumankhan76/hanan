...
const headerData = {
  name: "Hanan Semab",
  designation: "SMM | EDITOR | DESIGNER",
  imageThumb: "/images/logo.png",
  social: {
    facebook: "https://facebook.com",
    //twitter: "https://twitter.com",
    //instagram: "https://www.instagram.com/",
    youtue: "https://www.youtube.com/@hanansemab",
    behance: "https://www.behance.net/hanansemab",
        ...
        <div className="header-inner d-flex align-items-start flex-column">
          ...
          <nav>
            <ul className="vertical-menu scrollspy">
              ...
              <li>
                <Link to="/bloglist">
                  <i className="icon-pencil"></i>Academics
                </Link>
              </li>
              <li>
                <Link to="/contact">
          ...
          <div className="footer mt-auto">
            ...
            <span className="copyright">
              &copy; {new Date().getFullYear()} Hanan Semab
            </span>
          </div>
        </div>
      </header>
